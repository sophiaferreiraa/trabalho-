...
public class AssetsManager extends ApplicationAdapter {
    ...
    public void create() {
        ...
        // --- NOVOS ASSETS ---
        assetManager.load("assets/bueirao_fase2.png", Texture.class); // Fundo Fase 2
        assetManager.load("assets/Robot_enemy.png", Texture.class); // Inimigo Fase 2
        assetManager.load("assets/blue.png", Texture.class); // Bloco Fase 2
        // ---------------------
