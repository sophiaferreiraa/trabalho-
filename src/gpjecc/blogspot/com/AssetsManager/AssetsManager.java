...
public class AssetsManager {
    ...
    public void create() {
        ...
        // --- CARREGA TEXTURAS (sem usar "assets/" no caminho) ---
        ...
        // --- NOVOS ASSETS (corrigido: sem espaço e sem "assets/") ---
        assetManager.load("bueirao_fase2.jpeg", Texture.class); // Fundo Fase 2
        // Se precisar, carregue outros aqui...
        assetManager.load("bueirao.jpeg", Texture.class); // Fundo Fase 1 (exemplo)

        // Carrega também a música via AssetManager (recomendado)
        assetManager.load("2019-12-11_-_Retro_Platforming_-_David_Fesliyan.mp3", Music.class);

        assetManager.finishLoading(); // OK para testes / assets pequenos
