...
public class Enemy extends GameObject {
    ...
    public static void createEnemies(int level) {
        ...
        if (level == 1) {
            ...
            enemies.add(new Enemy(100, 50, 50, 150, fastSpeed, tex));
            enemies.add(new Enemy(200, 50, 150, 250, fastSpeed, tex));
            enemies.add(new Enemy(300, 50, 250, 350, fastSpeed, tex));
            enemies.add(new Enemy(450, 50, 400, 500, fastSpeed, tex));
            enemies.add(new Enemy(550, 50, 500, 600, fastSpeed, tex));
            enemies.add(new Enemy(700, 50, 650, 750, fastSpeed, tex));
            enemies.add(new Enemy(800, 50, 750, 850, fastSpeed, tex));
            enemies.add(new Enemy(900, 50, 850, 950, fastSpeed, tex));
        }
    }
}