...
public class Player extends GameObject {
    ...
    protected Player(boolean noLoad) {
            ...
            if (this.size == null)
                this.size = new com.badlogic.gdx.math.Vector2(23f, 45f);
            this.velocityY = 0f;
            this.onGround = false;
    ...
    public static Player createNetworkGhost(float x, float y, Blocks blocks, Ladders ladders) {
        Player p = new Player(true); // usa o construtor leve
        p.position.set(x, y);
    ...
    public static Player createNetworkGhost(Blocks blocks, Ladders ladders) {
