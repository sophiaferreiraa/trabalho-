-- ==========================================================
-- CORREÇÃO: Remove o banco antigo se existir e cria o novo com o nome CERTO
-- ==========================================================
DROP DATABASE IF EXISTS loja_cabelo;
...
-- Adicionando coluna de Marca na tabela Products
