...
<head>
    ...
    <style>
        .card-tabela { background-color:white; padding:30px; border-radius:10px; box-shadow:0 2px 5px rgba(0,0,0,0.1); max-width:900px; margin:0 auto;}
    ...
    <div class="card-tabela">
        <?php if (empty($compras)): ?>
            <div style="text-align:center; padding:20px;">
                ...
                <a href="/e-commerce/public/index.php?url=produtos" class="cadastro-button" style="display:inline-block; margin-top:10px;">Voltar à Loja</a>
            </div>
        <?php else: ?>
                ...
                <table>
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td style="color:#fa8a99; font-weight:bold;">R$ <?= number_format($compra['valor_total'],2,',','.'); ?></td>
                        </tr>
                        <?php endforeach; ?>
                    </tbody>
                </table>
