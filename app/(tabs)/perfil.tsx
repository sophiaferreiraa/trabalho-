  ...
  return (
    <ScrollView style={[styles.container, { backgroundColor: colors.background }]}>
      ...
      <View style={styles.section}>
        ...
        {/* Botão Modo Escuro totalmente clicável */}
        <TouchableOpacity
          style={[
            styles.row,
            { 
              backgroundColor: modoEscuro ? "#1B2A44" : "#F5F5F5", 
              borderRadius: 8, 
          ...
          activeOpacity={0.6}
        >
          <Text style={[styles.rowText, { color: colors.text, fontWeight: "500" }]}>
            Modo Escuro
          </Text>
          ...
          <Switch
            value={modoEscuro}
            onValueChange={() => {}} // vazio para não interferir no toque
            trackColor={{ false: "#CCC", true: colors.blueButton }}
            thumbColor="#fff"
            pointerEvents="none" // permite que o TouchableOpacity receba o toque
          />
        </TouchableOpacity>
      </View>
      ...
      <View style={styles.section}>
        <TouchableOpacity
          ...
          onPress={sair}
        >
          <Text style={[styles.rowText, { color: colors.blueButton }]}>
            Sair / Logout
          </Text>
        </TouchableOpacity>
      </View>
