    ...
    <SafeAreaView style={styles.safeArea}>
      <View style={styles.header}>
        <View>
          ...
          <Text style={styles.headerSubtitle}>Torne seus objetivos mais claros e {'\n'}fortaleça seu foco</Text>
        </View>
      ...
      <Modal animationType="slide" transparent visible={modalVisivel} onRequestClose={() => setModalVisivel(false)}>
        <View style={styles.modalContainer}>
          <View style={styles.modalView}>
            ...
            <TextInput placeholder="Título (opcional)" placeholderTextColor="#555" style={[styles.input, { color: '#000' }]} value={tituloMeta} onChangeText={setTituloMeta} />
            <TextInput placeholder="Descrição da meta" placeholderTextColor="#555" style={[styles.input, { color: '#000' }]} value={descricaoMeta} onChangeText={setDescricaoMeta} />
            <TextInput placeholder="Vencimento (ex: dez 2025)" placeholderTextColor="#555" style={[styles.input, { color: '#000' }]} value={vencimentoMeta} onChangeText={setVencimentoMeta} />
            <TextInput placeholder="Progresso inicial (0-100)" placeholderTextColor="#555" style={[styles.input, { color: '#000' }]} keyboardType="numeric" value={progressoMeta} onChangeText={setProgressoMeta} />
...
const styles = StyleSheet.create({
  ...
  header: { backgroundColor: '#007BFF', paddingHorizontal: 20, paddingTop: 50, paddingBottom: 25, borderBottomLeftRadius: 30, borderBottomRightRadius: 30, flexDirection: 'row', justifyContent: 'space-between', alignItems: 'center' },
  ...
  card: { width: '46%', backgroundColor: 'white', borderRadius: 15, padding: 15, marginVertical: 10, borderWidth: 1.5, borderColor: '#929090ff', minHeight: 180, justifyContent: 'space-between' },
  ...
  progressBarBackground: { height: 8, backgroundColor: '#929292ff', borderRadius: 4, width: '100%' },
  progressBarFill: { height: '100%', backgroundColor: '#767676', borderRadius: 4 },
  cardDueDate: { fontSize: 12, color: 'gray', marginTop: 5 },
  emptyContainer: { flex: 1, width: '100%', justifyContent: 'center', alignItems: 'center', marginTop: 100 },
  emptyText: { fontSize: 18, color: 'gray' },
  emptySubtext: { fontSize: 14, color: '#A0A0A0', marginTop: 10 },
  modalContainer: { flex: 1, justifyContent: 'center', alignItems: 'center', backgroundColor: 'rgba(0, 0, 0, 0.5)' },
  modalView: { width: '85%', backgroundColor: 'white', borderRadius: 20, padding: 20, alignItems: 'center', elevation: 5 },
  modalTitle: { fontSize: 20, fontWeight: 'bold', marginBottom: 20 },
  input: { width: '100%', borderWidth: 1, borderColor: '#ddd', padding: 10, borderRadius: 10, marginBottom: 15, fontSize: 16, color: '#333' },
