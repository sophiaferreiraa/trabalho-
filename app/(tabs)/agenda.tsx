...
const HelpTutorialOverlay = ({ step, setStep }: { step: number; setStep: (n: number) => void }) => {
  ...
  const textos = [
    ...
    {
      titulo: "1. O que é a Agenda?",
      texto: "Aqui você organiza seu dia a dia. Visualize suas tarefas, defina horários e prioridades para manter o foco no que importa hoje.",
      botaoTexto: "Próximo -->",
    },
    {
      titulo: "2. Como criar uma tarefa?",
      texto: "Toque no botão '+' no topo. Defina um título claro, o horário de execução e, se desejar, vincule essa tarefa a uma de suas Metas principais.",
      botaoTexto: "Entendi -->",
    },
    {
      titulo: "3. Prioridades e Cores",
      texto: "Use as cores para indicar a urgência:\n🔴 Alta (Vermelho)\n🟡 Média (Amarelo)\n🟢 Baixa (Verde)\nIsso ajuda a visualizar o que fazer primeiro!",
      botaoTexto: "Próximo -->",
    },
    {
      titulo: "4. Concluindo Tarefas",
      texto: "Ao terminar, toque no círculo ou check ao lado da tarefa. Isso atualiza seus gráficos de progresso e te dá aquela sensação de dever cumprido!",
