...
const API_URL = '[http://localhost:3001](http://localhost:3001)';
...
export default function AgendaScreen() {
  ...
  const { passoAtual, proximoPasso } = useTutorial(); // <--- Tutorial
  ...
  return (
    <SafeAreaView style={styles.safeArea}>
      ...
      <TutorialOverlay 
        ...
        texto="Aqui é sua Agenda Diária. Transforme as grandes metas em pequenas tarefas para hoje! Use o '+' para adicionar e o 'check' para concluir."
