...
export default function Progresso() {
  ...
  return (
    <ScrollView style={styles.container}>
      ...
      <Text style={styles.subtitle}>Visualize seu desempenho e estatísticas.</Text>
      ...
      <TutorialOverlay 
        ...
        texto="Acompanhe visualmente sua evolução. Ver o progresso nas barras ajuda a manter a motivação e o foco!"
