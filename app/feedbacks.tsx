...
export default function FeedbacksScreen() {
  ...
  const { perfilId } = useLocalSearchParams<{ perfilId?: keyof typeof PERFIS_FEEDBACK }>();
    ...
    return (
      <SafeAreaView style={styles.safeArea}>
        <View style={styles.container}>
          ...
          <Text style={styles.texto}>Não foi possível carregar seu perfil. Por favor, tente refazer o questionário.</Text>
        </View>
      </SafeAreaView>
    );
  }
  ...
  return (
    <SafeAreaView style={styles.safeArea}>
      <ScrollView contentContainerStyle={styles.container}>
        ...
        <TouchableOpacity style={styles.botaoConcluir} onPress={() => router.replace('/(tabs)/agenda')}>
