    ...
    <SafeAreaView style={styles.safeArea}>
      <View style={styles.container}>
        ...
        <ScrollView contentContainerStyle={styles.scrollContent}>
          {/* ESTE É O TEXTO QUE FOI MODIFICADO NO ESTILO ABAIXO */}
...
const styles = StyleSheet.create({
  ...
  // --- ALTERAÇÃO AQUI: Fonte maior e mais escura ---
  labelInstrucao: { 
    textAlign: 'center', 
    color: '#333',     // Cor mais escura (antes era #888)
    textTransform: 'uppercase', 
    fontSize: 18,      // Fonte maior (antes era 12)
    fontWeight: 'bold',// Mais peso para destacar
    letterSpacing: 1, 
    marginBottom: 10 
  },
